...
![Verify Gazebo Installation](/docs/phase-1-simulation/images/1.5_gz_verification.png)
...
![Start Gazebo First](/docs/phase-1-simulation/images/1.5_gz_first_open.png)
...
![Launch SITL with Gazebo](/docs/phase-1-simulation/images/1.5_gz_with_SITL.png)
...
![Test Flight in Gazebo](/docs/phase-1-simulation/images/1.5_gz_with_SITL_test.png)
...
![Gazebo Interface](/docs/phase-1-simulation/images/1.5_gz_interface.png)
...
sim_vehicle.py -v ArduCopter -f gazebo-iris --model JSON --map --console
```
![Launch in warehouse](/docs/phase-1-simulation/images/1.5_gz_with_SITL_warehouse.png)
