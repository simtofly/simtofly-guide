...
![Verify locale](images/2.1_locale_verification.png)
...
![ROS_DISTRO Environment](images/2.1_ROS_DISTRO_verification.png)
...
![Demo talker/listener working](images/2.1_ROS_eg.png)
...
![Ros2 Core concepts diagram](images/2.1_ros2_concepts.svg)

Topics, Services, Nodes, Messages explained through drone examples
