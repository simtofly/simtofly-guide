...
**Wait for movement to complete** (~10 seconds)
...
**Top toolbar:**
- **Play/Pause button** — Control simulation time
- **Real-time factor** — Simulation speed (1.0 = real-time)
- **Step button** — Advance one frame at a time

**Left panel (Entity Tree):**
- World tree — List of objects in simulation
- Entity details — Properties of selected object
- Can select drone, runway, lights, etc.

**3D viewport (Center):**
- Main visualization area
- Shows drone, environment, physics
...
**Reset camera to drone:**
1. Click on drone in left panel (Entity Tree)
2. Press `R` key — Camera focuses on drone

**Toggle wireframe mode:**
- View → Wireframe (shows 3D mesh structure)

**Show/hide panels:**
- Window → Entity Tree (toggle left panel)
- Window → Component Inspector (toggle right panel)
