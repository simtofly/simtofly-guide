...
### [1.6 First Autonomous Mission](1.6-first-mission.md)
...
2. Search [existing issues](https://github.com/simtofly/simtofly-guide/issues)
3. [Open a new issue](https://github.com/simtofly/simtofly-guide/issues/new) with:
